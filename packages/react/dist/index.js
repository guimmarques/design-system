...
function TextInput(props) {
  const _a = props, { prefix } = _a, rest = __objRest(_a, ["prefix"]);
...
function MultiStep(props) {
  const _a = props, { size, currentStep = 1 } = _a, rest = __objRest(_a, ["size", "currentStep"]);
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(MultiStepContainer, __spreadProps(__spreadValues({}, rest), { children: [
